...
Some gpt aided zooming with labels:
```{r setup, include=FALSE}
library(plotly)
library(tibble)
library(dplyr)
...
annotations_zoomed_out <- lapply(1:nrow(cluster_lookup), function(i) {
  list(
    ...
    showarrow = FALSE,
    font = list(size = 24, family = "helvetica", color = "black")
  )
})
    ...
    el.on('plotly_relayout', function(eventdata) {
      ...
      debounceTimeout = setTimeout(function() {
        ...
        if (zoomLevel < 2 && !currentZoomedOut) {
          newAnnotations = [
            { x: %f, y: %f, text: '%s', showarrow: false, font: { size: 24, family: 'helvetica', color: 'black' } },
            { x: %f, y: %f, text: '%s', showarrow: false, font: { size: 24, family: 'helvetica', color: 'black' } },
            { x: %f, y: %f, text: '%s', showarrow: false, font: { size: 24, family: 'helvetica', color: 'black' } },
            { x: %f, y: %f, text: '%s', showarrow: false, font: { size: 24, family: 'helvetica', color: 'black' } },
            { x: %f, y: %f, text: '%s', showarrow: false, font: { size: 24, family: 'helvetica', color: 'black' } }
...
",
                   cluster_lookup$centroid_x[1], cluster_lookup$centroid_y[1], cluster_lookup$label_zoomed_out[1],
                   cluster_lookup$centroid_x[2], cluster_lookup$centroid_y[2], cluster_lookup$label_zoomed_out[2],
                   cluster_lookup$centroid_x[3], cluster_lookup$centroid_y[3], cluster_lookup$label_zoomed_out[3],
                   cluster_lookup$centroid_x[4], cluster_lookup$centroid_y[4], cluster_lookup$label_zoomed_out[4],
                   cluster_lookup$centroid_x[5], cluster_lookup$centroid_y[5], cluster_lookup$label_zoomed_out[5],
                   cluster_lookup$label_zoomed_in_x[1], cluster_lookup$label_zoomed_in_y[1], cluster_lookup$label_zoomed_in[1],
                   cluster_lookup$label_zoomed_in_x[2], cluster_lookup$label_zoomed_in_y[2], cluster_lookup$label_zoomed_in[2],
                   cluster_lookup$label_zoomed_in_x[3], cluster_lookup$label_zoomed_in_y[3], cluster_lookup$label_zoomed_in[3],
                   cluster_lookup$label_zoomed_in_x[4], cluster_lookup$label_zoomed_in_y[4], cluster_lookup$label_zoomed_in[4],
                   cluster_lookup$label_zoomed_in_x[5], cluster_lookup$label_zoomed_in_y[5], cluster_lookup$label_zoomed_in[5]
)
