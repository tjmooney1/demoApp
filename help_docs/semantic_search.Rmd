...
```{r}
cosine_calculation_threshold(reference_statements = "cybersecurity", 
                             cosine_sim_thresholds = 0.3, 
...
```{r}
top_posts_cosine_similarity(reference_statements = "AI art is bad", 
...
## Perform semantic similarity on top 20 sentences
```{r}
