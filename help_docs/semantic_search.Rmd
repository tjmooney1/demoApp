...
bge_embeddings_sentences <- bt_do_embedding(bge_embedder, example_sentences$sentence)
...
bge_embeddings_sentences %>% write_rds("~/Google Drive/My Drive/Share_Clients/data_science_project_work/hackafun/data/semantic_search_data/example_bge_embeddings_sentences.rds")
...
# bge_embeddings_sentences <- read_rds("~/Google Drive/My Drive/Share_Clients/data_science_project_work/hackafun/data/semantic_search_data/example_bge_embeddings_sentences.rds")

# multi_qa_matrix_sentences <- multi_qa_embeddings_sentences %>%
#   as.matrix()

bge_matrix_sentences <- multi_qa_embeddings_sentences %>%
  as.matrix()
...
adjust_colour_darker <- function(colour_hex, og_val) {
  ...
  observeEvent(input$update_plot, {
    ...
    doc_id <- cosine_calculation_threshold_sentence(reference_statement = search_term,
                                                    cosine_sim_threshold = cosine_threshold,
                                                    embedding_model = multi_qa_embedder,
                                                    sentence_matrix = multi_qa_matrix_sentences,
                                                    df = example_sentences)
